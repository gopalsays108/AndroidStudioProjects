...
public class PdfAdapter extends ArrayAdapter<File> {
    ...
    public PdfAdapter(Context context, ArrayList<File> arrayListPdf) {
        super( context, R.layout.single_upload_pdf, arrayListPdf );
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from( getContext() ).inflate( R.layout.single_upload_pdf, parent, false );
        ...
        viewHolder.fileName.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Log.i( "COUNT+>", String.valueOf( number ) );
