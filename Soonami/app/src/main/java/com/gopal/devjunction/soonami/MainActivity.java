package com.gopal.devjunction.soonami;
...
public class MainActivity extends AppCompatActivity {
     ...
     */
    /*  name of the variable that holds the HTTP request URL */
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2019-01-01&endtime=2020-12-01&minmagnitude=7";
    ...
    private String getDateString(long timeInMilliseconds) {
        SimpleDateFormat formatter = new SimpleDateFormat( "EEE, d MMM yyyy 'at' HH:mm:ss z", Locale.getDefault() );
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            //If the url is @null then return Early with empty jsonResponse
            if (url == null) {
                return jsonResponse;
            }
            ...
            try {
                //Everything below this before .coonect is used to setting up HTTP request
                urlConnection = (HttpURLConnection) url.openConnection();
                urlConnection.setRequestMethod( "GET" );
                urlConnection.setReadTimeout( 10000 /* milliseconds */ );
                urlConnection.setConnectTimeout( 15000 /* milliseconds */ );

                // This line of code is where we establish the HTTP connection with server
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    jsonResponse = readFromStream( inputStream ); // This line gives the json text
                }else{
        ...
        private String readFromStream(InputStream inputStream) throws IOException {
            ...
            if (inputStream != null) {
                ...
                //t hat isit knows how to decode each byte in human readable character that is a, b,c
                //UTF-8 is the Unicode character encoding used for every piece of text we see
                InputStreamReader inputStreamReader = new InputStreamReader( inputStream, StandardCharsets.UTF_8 );  // Charset.forName( "UTF-8" )
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            ...
            if (TextUtils.isEmpty( earthquakeJSON )){  // Using TextUtils bcz it will always return a boolean value.
                return null;                          //Whereas For string.isEmpty(), a null string value will throw a NullPointerException
            }
